...
export default async function Image({
  ...
  const title = poll?.question ?? "Join this Poll on Open Poll";
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        <div
          style={{
            fontSize: title.length > 50 ? "58px" : "68px",
            fontWeight: "800",
            color: "#09090b",
            lineHeight: 1.15,
            letterSpacing: "-1.5px",
        ...
        >
          Real-time minimalist polling. Vote now.
        </div>
      </div>
